...
from ravage2d.errors import NetworkingError
...
class Header:
    ...
    def __repr__(self):
        return f"<ravage2d.networking.Header({self.fields})>"
...
class ConnectedClient(threading.Thread):
    ...
    def __repr__(self):
        return f"<ravage2d.networking.ConnectedClient(id={self.id}, {self.address}:{self.port})>"
...
class Server(threading.Thread):
    ...
    def __repr__(self):
        return f"<ravage2d.networking.Server({self.address}:{self.port})>"
...
class Connection(threading.Thread):
    ...
    def __repr__(self):
        return f"<ravage2d.networking.Connection({self.address}:{self.port})>"
