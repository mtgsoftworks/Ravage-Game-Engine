...
from ravage2d.math.geometry.aabb import AABB
from ravage2d.math.geometry import tripy
from ravage2d.math.geometry.collision import test_poly_poly, test_poly_circle, test_concave_poly_poly, \
...
class ConvexPolygon:
    ...
    def __repr__(self):
        return f"<ravage2d.math.geometry.ConvexPolygon({len(self.vertices)} vertices)>"
...
class ConcavePolygon:
    ...
    def __repr__(self):
        return f"<ravage2d.math.geometry.ConcavePolygon({len(self.vertices)} vertices)>"
