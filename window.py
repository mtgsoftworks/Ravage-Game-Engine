...
from ravage2d.math import Vector2
from ravage2d.color import Color
from ravage2d.libs.utils import source_path
from ravage2d.gl.texture import Texture



class Window:
    def __init__(self, size, title="Ravage2D Game Project", icon=None, clear_color=(0, 0, 0)):
    ...
    def __repr__(self):
        return f"<ravage2d.Window({self.width}x{self.height}, {self.title})>"
