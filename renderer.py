...
from ravage2d.version import OPENGL_VERSION, SDL_VERSION
from ravage2d.gl import Texture, Shader
...
class Renderer:
    ...
    def __repr__(self):
        return f"<ravage2d.Renderer(OpenGL {OPENGL_VERSION}, SDL {SDL_VERSION})>"
