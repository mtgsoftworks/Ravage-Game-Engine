import pygame
pygame.font.init()
from ravage2d import DISPATCHER, ravage2d_VERSION, PYGAME_VERSION, SDL_VERSION
...
def init():
    ...
    fps_graph.layers[2].surface.blit(font14.render(f"ravage2d  : {ravage2d_VERSION}", True, (255, 255, 255)), (295, 35))
