...
from ravage2d.math.geometry import Rectangle
from ravage2d.trigger import Trigger
from ravage2d.physics.collisionlistener import CollisionListener
...
class GameObject:
    ...
    def __repr__(self):
        return f"<ravage2d.GameObject({self.position})>"
